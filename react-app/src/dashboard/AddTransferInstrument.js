...
export default function AddTransferInstrument() {

    const [session, setSession] = React.useState(null)
    const createContainerRef = React.useRef(null);
    ...
    React.useEffect(() => {
        ...
        async function loadComponent() {
            ...
            adyenKycHandler
                ...
                .mount(createContainerRef.current);
        }
            ...
            <DashboardDrawer/>
              ...
              >
                  ...
                  <Divider sx={{ padding: 1 }}>
                      <Chip label="Add Transfer Instrument" variant="elevated" sx={{ minWidth: 100, fontSize: "20px", backgroundColor: "#0abf53", color: "white" }}/>
                  </Divider>
  
                  <Paper sx={{ width: '100%', display: session ? 'fixed': 'none'}}>
                      <div ref={createContainerRef}></div>
                  </Paper>
                  <br/><br/>
